...
export default ({
  ...
  buttonRoundedCss = "",
  heading = "MediaSentinel",
  description = "Welcome to MediaSentinel, an innovative AI-driven feedback and monitoring platform tailored for the Government of India’s media analysis needs. Leveraging advanced natural language processing and sentiment analysis, MediaSentinel classifies news from diverse sources—including national and regional news articles, e-papers, and video content—by relevant government departments and sentiment. The platform supports multiple languages and provides government officials with real-time alerts for sensitive or negative media coverage, empowering timely and informed responses to public sentiment and media trends, and strengthening transparency in government-public interactions."
}) => {
  useEffect(() => {
  ...
  return isLoading ? (
    ...
    <div
      style={{
        backgroundImage:
          //"url(https://as1.ftcdn.net/v2/jpg/03/41/65/14/1000_F_341651408_xpz7ly4un8nRtjzabt6qa1Yz0Ixpm2Ca.jpg)",
              ...
              <ImageColumn>
                <ImageContainer>
                  <Image
                    ...
                    //src= "https://64.media.tumblr.com/e45992a1d1b480d04ff0a8fd1de3dd54/tumblr_p4qg7kKK801r2geqjo1_540.gifv"
                    src="https://64.media.tumblr.com/8dcf184df55ea562190b56473df21e07/tumblr_ox7du4TtBx1r2geqjo1_540.gifv"
                    style={{
                      borderRadius: "50%",
                      pointerEvents: "none",
                      userSelect: "none",
